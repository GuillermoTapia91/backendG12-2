...
# que la imagen almacene de manera mas facil los archivos del proyecto porque al indicar la ubicacion del directorio de trabajo creara una carpeta en la imagen donde guardara todos los archivos copiados 
...
#se usar para instalar las librerias
